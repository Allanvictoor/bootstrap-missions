        ...
        <div class="col-2">
            <nav class="navbar navbar-white">
                <a><img src="https://www.gstatic.com/images/branding/product/1x/drive_48dp.png" alt="drive"><small
                            style="font-size: 25px;" class="ml-2">Drive</small></a>
            </nav>
        </div>
        <div class="col-7">
            <div class="input-group border mt-2 ml-2">
                <span class="input-group-btn">
                    <button class="btn btn-default bg-light" type="button"><i class="fas fa-search"></i></button>
                </span>
                <input class="form-control bg-light" type="search" placeholder="Pesquisar no Drive" arial-label="Search"
                       style="border: none">
                <span class="input-group-btn">
                    <button class="btn btn-default bg-light" type="button"><i class="fas fa-sort-down"></i></button>
                </span>
            </div>
        </div>
        <div class="col mt-2 d-flex justify-content-end" style="font-size: 25px">
            <div class="mr-5">
...
<div class="container-fluid ">
    <div class="row">
        <div class="col-2">
            <div class="row">
                <div class="m-2">
                    <div class="btn shadow p-3 bg-white" style="border-radius: 100px; width: 130px;">
                        <span class="card-text mt-2" style="font-size: 20px"><i
                                    class="fas fa-plus mx-2"></i><small>Novo</small></span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="btn btn-light pr-5 w-100"
                     style="border-bottom-right-radius: 50px; border-top-right-radius: 50px; background-color: #e8f0fe">
                    <a id="drive" href="meu-drive" style="text-decoration: none; color: blue"
                ...
                <div class="btn btn-light pr-5 w-100"
                    ...
                    <a id="drive" href="compartilhados-comigo" style="text-decoration: none; color: black"
                       class="card-text d-flex justify-content-start">
                ...
                <div class="btn btn-light w-100"
                     style="border-bottom-right-radius: 50px; border-top-right-radius: 50px;">
                    <a id="drive" href="recentes" style="text-decoration: none; color: black"
                       class="card-text d-flex justify-content-start">
                ...
                <div class="btn btn-light w-100"
                     style="border-bottom-right-radius: 50px; border-top-right-radius: 50px;">
                    <a id="drive" href="com-estrelas" style="text-decoration: none; color: black"
                       class="card-text d-flex justify-content-start">
                ...
                <div class="btn btn-light w-100"
                     style="border-bottom-right-radius: 50px; border-top-right-radius: 50px;">
                    <a id="drive" href="lixeira" style="text-decoration: none; color: black"
                       class="card-text d-flex justify-content-start">
                ...
                <div class="row">
                    ...
                    <div class="ml-5">
                        <div class="progress ml-3" style="height: 5px; width: 160px">
                        ...
                        <div class="ml-2 mt-2">
                            <div class="card">
                                <div class="btn btn-light">
                                    <p class="card-text"<a href="" style="text-decoration: none"><small>Comprar
        ...
        <div class="col">
            <div class="container-fluid">
                <div class="row border-bottom">
                    <div class="dropdown">
                        <button type="button" class="btn btn-link mt-2 dropdown-toggle"
                                style="text-decoration: none; color: black;">Meu Drive
                        </button>
                    </div>
                </div>
        ...
        <div class="border">
            <div class="ml-3 mr-3" style="font-size: 30px">
                <div class="mt-3">
