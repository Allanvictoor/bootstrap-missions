        ...
        <div class="container">
            <div class="row">
                ...
                <div class="services-section-bg-graphics">
                    <img src="https://www.codefest.co.uk/demo/codelander/assets/images/services-section-bg.png">
                </div>
                <section class="col-md-12">
                    <div class="row mt-5">
                        <div class="col-md-6">
                ...
                <section class="col-md-12">
                    <div class="row mt-5">
                        ...
                        <div class="col-md-6">
                            <div class="services-title-section section-text-top">
                                <p class="services-subtitle">Our services</p>
                                <h2 class="services-title">Sales Growth</h2>
                                <p class="services-text">
                                    You can talk about your secondary services here, or maybe
                                    promote your excellent customer service approach. Always grab your website visitors'
                                    attention.
                                </p>
                                <div class="btn-section-um"><b>View Pricing</b></div>
                            </div>
                        </div>
                    </div>
                </section>
